  ...
  return (
    <main className="min-h-screen flex flex-col">
      <div className="w-full flex justify-center py-4 px-6 md:px-12 bg-card/50">
        <img src="https://ng.jumia.is/cms/0-6-anniversary/2026/Initiatives/Voucher-drop/Desktop-Double-banner-572px-x250px.gif" alt="Anniversary Ad" className="w-full max-w-lg md:max-w-xl rounded-2xl shadow-sm object-cover" />
      </div>
      {/* Top bar */}
